...
class Computer:
    ...
    def __str__(self):
        return f"Computer specs: Processor: {self.processor}, Memory: {self.memory}, Storage: {self.storage}, Graphics Card: {self.graphics_card}, OS: {self.operating_system}"
